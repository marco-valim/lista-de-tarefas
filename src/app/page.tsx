    ...
    <main className="w-full h-screen bg-gray-400 flex justify-center items-center">
      <Card className='w-lg'>
        ...
        <div className='flex gap-2'>          
          ...
          <Badge className="cursor-pointer" variant="outline"><CircleX />Não finalizadas</Badge>
        ...
        <div className='flex justify-between'>
          ...
          <Button className='text-xs h-7 mt-4 cursor-pointer' variant='outline'><Trash />Limpar Tarefas Concluídas</Button>
        </div>
